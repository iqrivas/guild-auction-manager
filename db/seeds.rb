...
auction_item1 = AuctionItem.create(opening_bid: 100, sold_for: nil, payment_status: 0, is_bundle: false, auction_id: auction1.id, item_id: item1.id, user_id: user1.id)
auction_item2 = AuctionItem.create(opening_bid: 200, sold_for: nil, payment_status: 0, is_bundle: false, auction_id: auction1.id, item_id: item2.id, user_id: user2.id)
auction_item3 = AuctionItem.create(opening_bid: 300, sold_for: nil, payment_status: 0, is_bundle: false, auction_id: auction2.id, item_id: item3.id, user_id: user2.id)
